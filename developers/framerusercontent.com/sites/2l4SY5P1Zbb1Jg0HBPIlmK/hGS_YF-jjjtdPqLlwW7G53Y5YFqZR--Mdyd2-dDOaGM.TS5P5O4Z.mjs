                          ...
                          overrides: {
                            uDmuB0FSr: {
                              background: {
                                ...
                                src: "/developer.png",
                                srcSet:
                                  "/developer.png?scale-down-to=1024 841w,/developer.png 1669w",
                              },
                            },
                            Vqfer6d2J: {
                              background: {
                          ...
                          overrides: {
                            uDmuB0FSr: {
                              background: {
                                ...
                                src: "/developer1.png",
                                srcSet:
                                  "/developer1.png?scale-down-to=512 512w,/developer1.png?scale-down-to=1024 1024w,/developer1.png 1521w",
                              },
                            },
                            Vqfer6d2J: {
                              background: {
